...
export const metadata: Metadata = {
  title: "Python Course in Gurgaon | Best Python Training — SSSAM Academy",
  description: "Best Python course in Gurgaon at SSSAM Academy. Learn Python programming, automation, data science, and machine learning with live mentorship, real projects, and a training certificate.",
  alternates: { canonical: "${siteUrl}/python-course-gurgaon" },
  openGraph: {
    title: "Python Course in Gurgaon | Best Python Training — SSSAM Academy",
    description: "Best Python course in Gurgaon at SSSAM Academy. Learn Python programming, automation, data science, and machine learning with live mentorship, real projects, and a training certificate.",
    type: "website",
    url: "${siteUrl}/python-course-gurgaon",
    siteName: "SSSAM Academy",
    locale: "en_IN",
    images: [{ url: "${siteUrl}/images/logo/logo.png", width: 1200, height: 630, alt: "Python Course in Gurgaon | Best Python Training — SSSAM Academy" }],
  },
  twitter: { card: "summary_large_image", title: "Python Course in Gurgaon | Best Python Training — SSSAM Academy", description: "Best Python course in Gurgaon at SSSAM Academy. Learn Python programming, automation, data science, and machine learning with live mentorship, real projects, and a training certificate." },
  keywords: "Python course Gurgaon,Python training Gurgaon,learn Python Gurgaon,Python classes Gurgaon,Python programming Gurgaon,Python institute Gurgaon,Python certification Gurgaon",
};
...
export default function Page() {
    ...
    "@graph": [
      {
        ...
        name: "SSSAM Academy",
        url: siteUrl,
        description: "Learn Python programming in Gurgaon with SSSAM Academy. Our Python course covers core Python, data structures, automation, web scraping, and data science applications with live projects.",
      ...
      {
        "@type": "Course",
        name: "Python Course in Gurgaon — SSSAM Academy",
        description: "Learn Python programming in Gurgaon with SSSAM Academy. Our Python course covers core Python, data structures, automation, web scraping, and data science applications with live projects.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Python Course in Gurgaon — SSSAM Academy", item: "${siteUrl}/python-course-gurgaon" },
        ],
      },
      {
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the best Python institute in Gurgaon?", acceptedAnswer: { "@type": "Answer", text: "SSSAM Academy is one of the best Python Programming institutes accessible from Gurgaon. We offer 8 weeks training with live mentorship, real projects, a certificate, and dedicated placement support." } },
          ...
          { "@type": "Question", name: "Is the Python course available online for Gurgaon students?", acceptedAnswer: { "@type": "Answer", text: "Yes! SSSAM Academy offers both online and blended learning so students from Gurgaon can join live sessions remotely and access all course content online." } },
  ...
  const relatedSearches = ["Python for data science Gurgaon","Python Django course Gurgaon","Python automation Gurgaon","Python machine learning Gurgaon","Python Flask course Gurgaon"];
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <nav className="text-sm text-blue-300 mb-6">
            ...
            <span className="text-white">Python Course in Gurgaon — SSSAM Academy</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Python Course in Gurgaon — SSSAM Academy</h1>
          <p className="text-blue-200 text-xl max-w-3xl mx-auto mb-8">Learn Python programming in Gurgaon with SSSAM Academy. Our Python course covers core Python, data structures, automation, web scraping, and data science applications with live projects.</p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">Why SSSAM Academy is the Best Python Institute in Gurgaon</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "What is the best Python institute in Gurgaon?", a: "SSSAM Academy is one of the best Python Programming institutes accessible from Gurgaon. We offer 8 weeks training with live mentorship, real projects, a certificate, and dedicated placement support." },
              ...
              { q: "Is the Python course available online for Gurgaon students?", a: "Yes! SSSAM Academy offers both online and blended learning. Students from Gurgaon can join live sessions remotely and access all course content online with mentor support." },
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Start Your Python Career in Gurgaon Today!</h2>
