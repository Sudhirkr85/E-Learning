        ...
        <Container>
          <div className="max-w-md mx-auto w-full">
            <Card className="border border-slate-800 bg-slate-900/95 p-12 text-center shadow-2xl shadow-black/40">
              ...
              <Text color="muted" className="mb-6 text-slate-400">
                Don't worry, no charges were made. Please try again or contact support if the problem
                persists.
              </Text>
              ...
              <div className="mt-6 text-sm text-slate-300">
                ...
                <div className="flex flex-col gap-1 items-center">
                  ...
                  <a href="tel:+919217031899" className="text-cyan-400 hover:underline">
                    9217031899
                  </a>
                </div>
              </div>
