...
export const metadata: Metadata = {
  title: "Web Development Course in Gurgaon | SSSAM Academy",
  description: "Best web development course in Gurgaon. Learn HTML, CSS, JavaScript, Node.js, MongoDB, and AI tools in 30 days with live mentorship and placement support at SSSAM Academy.",
  alternates: { canonical: "${siteUrl}/web-development-course-gurgaon" },
  openGraph: {
    title: "Web Development Course in Gurgaon | SSSAM Academy",
    description: "Best web development course in Gurgaon. Learn HTML, CSS, JavaScript, Node.js, MongoDB, and AI tools in 30 days with live mentorship and placement support at SSSAM Academy.",
    type: "website",
    url: "${siteUrl}/web-development-course-gurgaon",
    siteName: "SSSAM Academy",
    locale: "en_IN",
    images: [{ url: "${siteUrl}/images/logo/logo.png", width: 1200, height: 630, alt: "Web Development Course in Gurgaon | SSSAM Academy" }],
  },
  twitter: { card: "summary_large_image", title: "Web Development Course in Gurgaon | SSSAM Academy", description: "Best web development course in Gurgaon. Learn HTML, CSS, JavaScript, Node.js, MongoDB, and AI tools in 30 days with live mentorship and placement support at SSSAM Academy." },
  keywords: "web development course Gurgaon,web development training Gurgaon,website development Gurgaon,HTML CSS course Gurgaon,JavaScript course Gurgaon,web developer course Gurgaon,frontend development Gurgaon",
};
...
export default function Page() {
    ...
    "@graph": [
      {
        ...
        name: "SSSAM Academy",
        url: siteUrl,
        description: "Learn web development in Gurgaon with SSSAM Academy. Build real websites using HTML, CSS, JavaScript, Tailwind CSS, Node.js, MongoDB, and AI coding tools in just 30 days.",
      ...
      {
        "@type": "Course",
        name: "Web Development Course in Gurgaon — SSSAM Academy",
        description: "Learn web development in Gurgaon with SSSAM Academy. Build real websites using HTML, CSS, JavaScript, Tailwind CSS, Node.js, MongoDB, and AI coding tools in just 30 days.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Web Development Course in Gurgaon — SSSAM Academy", item: "${siteUrl}/web-development-course-gurgaon" },
        ],
      },
      {
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the best Web Dev institute in Gurgaon?", acceptedAnswer: { "@type": "Answer", text: "SSSAM Academy is one of the best Web Development institutes accessible from Gurgaon. We offer 30 days training with live mentorship, real projects, a certificate, and dedicated placement support." } },
          ...
          { "@type": "Question", name: "Is the Web Dev course available online for Gurgaon students?", acceptedAnswer: { "@type": "Answer", text: "Yes! SSSAM Academy offers both online and blended learning so students from Gurgaon can join live sessions remotely and access all course content online." } },
  ...
  const relatedSearches = ["full stack course Gurgaon","React course Gurgaon","Node.js course Gurgaon","MERN stack Gurgaon","website design course Gurgaon","UI UX course Gurgaon"];
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <nav className="text-sm text-blue-300 mb-6">
            ...
            <span className="text-white">Web Development Course in Gurgaon — SSSAM Academy</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Web Development Course in Gurgaon — SSSAM Academy</h1>
          <p className="text-blue-200 text-xl max-w-3xl mx-auto mb-8">Learn web development in Gurgaon with SSSAM Academy. Build real websites using HTML, CSS, JavaScript, Tailwind CSS, Node.js, MongoDB, and AI coding tools in just 30 days.</p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">Why SSSAM Academy is the Best Web Dev Institute in Gurgaon</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "What is the best Web Dev institute in Gurgaon?", a: "SSSAM Academy is one of the best Web Development institutes accessible from Gurgaon. We offer 30 days training with live mentorship, real projects, a certificate, and dedicated placement support." },
              ...
              { q: "Is the Web Dev course available online for Gurgaon students?", a: "Yes! SSSAM Academy offers both online and blended learning. Students from Gurgaon can join live sessions remotely and access all course content online with mentor support." },
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Start Your Web Dev Career in Gurgaon Today!</h2>
