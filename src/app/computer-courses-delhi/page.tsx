...
export const metadata: Metadata = {
  title: "Computer Courses in Delhi | SSSAM Academy — Top Rated",
  description: "Best computer courses in Delhi at SSSAM Academy. Learn Web Development, Python, Data Science, and Digital Marketing with live projects, certificate, and placement support.",
  alternates: { canonical: "${siteUrl}/computer-courses-delhi" },
  openGraph: {
    title: "Computer Courses in Delhi | SSSAM Academy — Top Rated",
    description: "Best computer courses in Delhi at SSSAM Academy. Learn Web Development, Python, Data Science, and Digital Marketing with live projects, certificate, and placement support.",
    type: "website",
    url: "${siteUrl}/computer-courses-delhi",
    siteName: "SSSAM Academy",
    locale: "en_IN",
    images: [{ url: "${siteUrl}/images/logo/logo.png", width: 1200, height: 630, alt: "Computer Courses in Delhi | SSSAM Academy — Top Rated" }],
  },
  twitter: { card: "summary_large_image", title: "Computer Courses in Delhi | SSSAM Academy — Top Rated", description: "Best computer courses in Delhi at SSSAM Academy. Learn Web Development, Python, Data Science, and Digital Marketing with live projects, certificate, and placement support." },
  keywords: "computer courses Delhi,computer classes Delhi,computer course in Delhi,basic computer course Delhi,computer training Delhi,online computer course Delhi,computer institute Delhi",
};
...
export default function Page() {
    ...
    "@graph": [
      {
        ...
        name: "SSSAM Academy",
        url: siteUrl,
        description: "Join SSSAM Academy for the best computer courses in Delhi. We offer Web Development, Data Science, Cyber Security, Python, and Digital Marketing training with certificate and placement support.",
      ...
      {
        "@type": "Course",
        name: "Computer Courses in Delhi — Join SSSAM Academy",
        description: "Join SSSAM Academy for the best computer courses in Delhi. We offer Web Development, Data Science, Cyber Security, Python, and Digital Marketing training with certificate and placement support.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Computer Courses in Delhi — Join SSSAM Academy", item: "${siteUrl}/computer-courses-delhi" },
        ],
      },
      {
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the best Computer institute in Delhi?", acceptedAnswer: { "@type": "Answer", text: "SSSAM Academy is one of the best Computer Courses institutes accessible from Delhi. We offer 30 days - 6 months training with live mentorship, real projects, a certificate, and dedicated placement support." } },
          ...
          { "@type": "Question", name: "Is the Computer course available online for Delhi students?", acceptedAnswer: { "@type": "Answer", text: "Yes! SSSAM Academy offers both online and blended learning so students from Delhi can join live sessions remotely and access all course content online." } },
  ...
  const relatedSearches = ["MS Office course Delhi","computer diploma Delhi","basic IT course Delhi","tally course Delhi","advanced computer course Delhi","coding course Delhi"];
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <nav className="text-sm text-blue-300 mb-6">
            ...
            <span className="text-white">Computer Courses in Delhi — Join SSSAM Academy</span>
          </nav>
          <span className="inline-block bg-orange-500 text-white text-sm font-bold px-5 py-2 rounded-full mb-4">#1 Rated in Delhi</span>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Computer Courses in Delhi — Join SSSAM Academy</h1>
          <p className="text-blue-200 text-xl max-w-3xl mx-auto mb-8">Join SSSAM Academy for the best computer courses in Delhi. We offer Web Development, Data Science, Cyber Security, Python, and Digital Marketing training with certificate and placement support.</p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">Why SSSAM Academy is the Best Computer Institute in Delhi</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "What is the best Computer institute in Delhi?", a: "SSSAM Academy is one of the best Computer Courses institutes accessible from Delhi. We offer 30 days - 6 months training with live mentorship, real projects, a certificate, and dedicated placement support." },
              ...
              { q: "Is the Computer course available online for Delhi students?", a: "Yes! SSSAM Academy offers both online and blended learning. Students from Delhi can join live sessions remotely and access all course content online with mentor support." },
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Start Your Computer Career in Delhi Today!</h2>
