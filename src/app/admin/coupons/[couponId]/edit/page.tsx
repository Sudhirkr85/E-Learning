...
export default function EditCoupon({ params }: { params: { couponId: string } }) {
  ...
  const fetchCoupon = async () => {
    try {
      const response = await fetch(`/api/admin/coupons/${params.couponId}`);
      ...
      if (data.success) {
        ...
        setFormData({
          ...data.coupon,
          validFrom: new Date(data.coupon.validFrom).toISOString().split('T')[0],
          validUntil: new Date(data.coupon.validUntil).toISOString().split('T')[0],
        });
      } else {
    ...
    return (
      <div className="p-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">The coupon you're trying to edit doesn't exist.</p>
          <Link
            href="/admin/coupons"
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Update coupon information and settings</p>
      </div>
