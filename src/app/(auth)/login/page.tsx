          ...
          <div className="relative z-10 flex min-h-screen items-center py-12 md:py-16">
            <div className="grid w-full items-center gap-10 lg:grid-cols-2 lg:gap-14">
              ...
              <section className="mx-auto w-full max-w-[520px]">
                <div className="mb-6 text-center text-slate-100 lg:hidden">
                  <Heading level={2} className="mb-2 text-3xl text-white">
                    Sign in to SSSAM Academy
                  </Heading>
                  <Text className="text-slate-300">Welcome back! Continue your learning journey.</Text>
                  <Text className="mt-2 text-slate-400">Access your courses, projects, and certificate support.</Text>
                </div>
